...
```bash
code --install-extension jemo-theme-0.0.3.vsix
```
...
The workflow in `.github/workflows/release-vsix.yml` builds a VSIX, uploads it as an artifact, and attaches it to a GitHub Release when you push a tag like `v0.0.3`.
